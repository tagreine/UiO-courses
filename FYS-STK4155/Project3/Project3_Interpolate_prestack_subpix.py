...
from CNN_Interpolate_subpix_tf import create_CNN_int,create_loss,create_optimizer,create_placeholders, Interpolation_model
...
for i in range(n):
    ...
    plt.imshow(target_[i+m].reshape(200, 200),aspect="auto")
    plt.gray()
    ax.get_xaxis().set_visible(False)
    ax.get_yaxis().set_visible(False)
    ax.set_title('Truth')
    ...
    plt.imshow(input_[i+m].reshape(200, 50),aspect="auto")
    ...
    plt.imshow(out_train[i+m].reshape(200, 200),aspect="auto")
    plt.gray()
    ax.get_xaxis().set_visible(False)
    ax.get_yaxis().set_visible(False)
    ...
    plt.imshow((out_train[i+m].reshape(200, 200) - target_[i+m].reshape(200, 200)),aspect="auto")
    plt.gray()
    ax.get_xaxis().set_visible(False)
    ax.get_yaxis().set_visible(False)
