...
from CNN_Interpolate_subpix_reg_tf import create_CNN_int,create_loss,create_optimizer,create_placeholders, Interpolation_model, create_huber_loss
...
display_training_im(target_, input_, a=200, b=100, ratio = 4,n=4,c=0.2,save='True',name='Results\Targets_Inputs.png')
