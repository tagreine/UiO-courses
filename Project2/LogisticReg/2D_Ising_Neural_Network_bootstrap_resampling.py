...
axarr[0].semilogx(lmbdas, error_l, '*--b', lmbdas, error_t_l, '*--r', lmbdas[np.argmin(error_t_l)], np.min(error_t_l), 'x--k', lw=2)
...
axarr[1].semilogx(lmbdas, error_tan, '*--b', lmbdas, error_t_tan, '*--r', lmbdas[np.argmin(error_t_tan)], np.min(error_t_tan), 'x--k', lw=2)
...
axarr[2].semilogx(lmbdas, error_r, '*--b', lmbdas, error_t_r, '*--r', lmbdas[np.argmin(error_t_r)], np.min(error_t_r), 'x--k', lw=2)
